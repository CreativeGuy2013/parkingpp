...
class HistoryPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: Text(AppLocalizations.of(context).helpHistoryTitle),
        ),
        body: ListView(
          children: <Widget>[
            StreamBuilder(
                    ...
                    return Column(
                      children: snapshot.data.documents
                        ...
                        return ParkingLocation(
                            LatLng(ticket['location'].latitude,
...
class ParkingLocation extends ListTile {
  ...
  ParkingLocation(this.loc, this.start, this.numberplate, this.price,
      this.duration, this.mapsheet);
  ...
  Widget build(BuildContext context) {
    return ListTile(
        ...
        isThreeLine: true,
        title: Text("$start (Licence Plate: $numberplate)",
            style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20)),
        subtitle: FutureBuilder(
            future: getAdressFromLocation(loc.latitude, loc.longitude),
                ...
                default:
                  return Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("Price: €$price (${_getTimeSpend()})")
                    ],
                  );
              }
            }));
